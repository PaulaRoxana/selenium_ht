...
public class PageObjects {
    public static final By DELIVER_TO_BUTTON = By.xpath("//span[contains(text(),\"Deliver to\")]");
    ...
    public static final By KEYBOARD_CATEGORY = By.xpath("//span[text()='Keyboards']");
    public static final By FIODIO_KEYBOARD = By.xpath("//img[starts-with(@alt,\"Sponsored Ad - Fiodio R\")]");
    public static final By SHIP_TO_POLAND = By.xpath("//span[contains(text(),\"No \")]");
    public static final By REDRAGON_KEYBOARD = By.xpath("//img[starts-with(@alt,\"Redragon S101\")]");
    ...
    public static final By PRICE_IS_ZERO = By.xpath("//span[contains(text(),\"$0.00\")]");
}
